# Browser-local PDF form builder, filler, signer and page editor (`local-pdf-forms-signer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://local-pdf-forms-signer.sociobot.in`. Artifact class: `static-web`.
